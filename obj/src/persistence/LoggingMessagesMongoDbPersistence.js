...
const LoggingMessagesMongoDbSchema_1 = require("./LoggingMessagesMongoDbSchema");
class LoggingMessagesMongoDbPersistence extends pip_services_data_node_1.IdentifiableMongoDbPersistence {
    constructor() {
        super('logs', LoggingMessagesMongoDbSchema_1.LoggingMessagesMongoDbSchema());
