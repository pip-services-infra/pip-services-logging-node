...
const LoggingMongoDbPersistence_1 = require("../persistence/LoggingMongoDbPersistence");
...
class LoggingServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        ...
        this.registerAsType(LoggingServiceFactory.MongoDbPersistenceDescriptor, LoggingMongoDbPersistence_1.LoggingMongoDbPersistence);
...
LoggingServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-logging", "persistence", "mongodb", "*", "1.0");
