...
LoggingServiceFactory.LoggingMessagesMemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-logging", "persistence-messages", "memory", "*", "1.0");
LoggingServiceFactory.LoggingErrorsMemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-logging", "persistence-errors", "memory", "*", "1.0");
LoggingServiceFactory.LoggingMessagesMongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-logging", "persistence-messages", "mongodb", "*", "1.0");
LoggingServiceFactory.LoggingErrorsMongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-logging", "persistence-errors", "mongodb", "*", "1.0");
