...
import { LogsMongoDbPersistence} from '../persistence/LogsMongoDbPersistence';
import { ErrorsMongoDbPersistence} from '../persistence/ErrorsMongoDbPersistence';
...
export class LoggingServiceFactory extends Factory {
	...
	public static LogsMongoDbPersistenceDescriptor = new Descriptor("pip-services-logging", "persistence", "mongodb", "logs", "1.0");
	public static ErrorsMongoDbPersistenceDescriptor = new Descriptor("pip-services-logging", "persistence", "mongodb", "errors", "1.0");
	...
	constructor() {
		...
		this.registerAsType(LoggingServiceFactory.LogsMongoDbPersistenceDescriptor, LogsMongoDbPersistence);
		this.registerAsType(LoggingServiceFactory.ErrorsMongoDbPersistenceDescriptor, ErrorsMongoDbPersistence);
